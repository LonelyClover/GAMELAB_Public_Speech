...
class Data:
    ...
    def __init__(self):
        ...
        self.countries = ['Беларусь', 'Казахстан', 'Узбекистан', 'Китай']
        ...
        self.companies = dict(zip(self.countries, ['"Камика-Ойл"', '"Тенгизшевройл"', '"Андижаннефть"', '"Sinopec"']))
        ...
        self.plaintiffs = ['ПАО "ЛУКОЙЛ"', 'ПАО "Газпром нефть"', 'ПАО "НК Роснефть"', 'ПАО "НОВАТЭК"']
